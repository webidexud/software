...
//CONTRATISTAS - CONTRATOS ASOCIADOS A PROYECTOS

/**
 * Obtiene los contratistas asociados a un proyecto específico
 * @param int $proyectoId ID del proyecto
 * @return array Lista de contratistas asociados
 */
function obtenerContratistasProyecto($proyectoId) {
    try {
        // Obtener conexión
        $conn = conectarOracle();
        ...
        if (!$stid) {
            $e = oci_error($conn);
            error_log("Error al preparar consulta de contratistas: " . $e['message']);
            return [];
        }
        ...
        if (!$r) {
            $e = oci_error($stid);
            error_log("Error al ejecutar consulta de contratistas: " . $e['message']);
            return [];
        }
        ...
        error_log("Error en obtenerContratistasProyecto: " . $e->getMessage());
        return [];
    }
}
