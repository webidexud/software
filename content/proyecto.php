...
.page-header {
    background: linear-gradient(135deg, var(--primary), #4357c9);
    padding: 30px;
    border-radius: 16px;
    box-shadow: var(--shadow-md);
    margin-bottom: 30px;
...
.action-btn:hover, .action-btn:focus {
    background: linear-gradient(to right, rgba(94, 114, 228, 0.15), rgba(94, 114, 228, 0.1));
    color: var(--primary);
...
.btn-add-project {
    background: linear-gradient(45deg, var(--primary), #4357c9);
    border: none;
    box-shadow: var(--shadow-sm);
    transition: var(--transition);
    font-weight: 600;
...
.btn-add-project:hover {
    ...
    box-shadow: var(--shadow-md);
    background: linear-gradient(45deg, #4357c9, var(--primary));
}
...
/* Botón flotante y menú de acciones rápidas */
.mobile-add-btn {
    position: fixed;
    bottom: 30px;
    right: 30px;
...
.quick-action-btn:hover .label {
    opacity: 1;
    transform: translateX(0);
}

.quick-action-filter {
    background: linear-gradient(45deg, var(--info), #0ba7c5);
}

.quick-action-download {
    background: linear-gradient(45deg, var(--success), #20a46d);
}

.quick-action-help {
    background: linear-gradient(45deg, var(--warning), #e95726);
}
...
<!-- Botón flotante y menú de acciones rápidas para dispositivos móviles -->
<div class="floating-actions">
    <!-- Menú de acciones rápidas -->
    <div class="quick-actions" id="quickActions">
        <a href="#" class="quick-action-btn quick-action-filter" id="quickFilterBtn">
            <i class="fas fa-filter"></i>
            <span class="label">Filtros rápidos</span>
        </a>
        <a href="#" class="quick-action-btn quick-action-download" id="quickExportBtn">
            <i class="fas fa-file-export"></i>
            <span class="label">Exportar vista</span>
        </a>
        <a href="#" class="quick-action-btn quick-action-help" id="quickHelpBtn">
    ...
    <!-- Botón principal -->
    <a href="#" class="mobile-add-btn" id="mobileActionBtn">
        <i class="fas fa-plus" id="mobileActionIcon"></i>
    </a>
</div>
                        ...
                        <tr class="proyecto-row">
                            ...
                            <td class="text-center">
                                <div class="dropdown action-dropdown">
                                    <button class="btn btn-sm btn-light-primary dropdown-toggle action-btn" type="button" id="dropdownMenuButton-<?php echo $proyecto['id']; ?>" data-bs-toggle="dropdown" aria-expanded="false">
                                        Acciones <i class="fas fa-ellipsis-v ms-1"></i>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm action-menu" aria-labelledby="dropdownMenuButton-<?php echo $proyecto['id']; ?>">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="main.php?page=proyecto_individual&id=<?php echo $proyecto['id']; ?>">
                                                <i class="fas fa-eye text-primary me-2"></i> Ver detalles
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="main.php?page=editar_proyecto&id=<?php echo $proyecto['id']; ?>">
                                                <i class="fas fa-edit text-info me-2"></i> Editar proyecto
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="main.php?page=agregar_acta&proyecto_id=<?php echo $proyecto['id']; ?>">
                                                <i class="fas fa-file-signature text-success me-2"></i> Agregar acta
                                            </a>
                                        </li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#" onclick="exportarProyecto(<?php echo $proyecto['id']; ?>); return false;">
                                                <i class="fas fa-file-export text-warning me-2"></i> Exportar
                                            </a>
                                        </li>
                                    </ul>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar botones flotantes para móvil
...
// Función para configurar botones de acciones flotantes para móvil
function configurarBotonesFlotantes() {
    ...
    if (mobileActionBtn) {
        mobileActionBtn.addEventListener('click', function(e) {
            ...
            quickActions.classList.toggle('show', menuOpen);
            
            // Cambiar icono del botón principal
            if (menuOpen) {
                mobileActionIcon.className = 'fas fa-times';
            } else {
                mobileActionIcon.className = 'fas fa-plus';
            }
        });
    }
    ...
    if (quickFilterBtn) {
        quickFilterBtn.addEventListener('click', function(e) {
            e.preventDefault();
            ...
            // Scroll hasta el panel de filtros
    ...
    if (quickHelpBtn) {
        quickHelpBtn.addEventListener('click', function(e) {
            e.preventDefault();
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="help-section mb-4">
                        ...
                        <ul class="help-list">
                            ...
                            <li><i class="fas fa-edit text-info me-2"></i> <strong>Editar proyecto</strong>: Permite modificar los datos del proyecto</li>
                            <li><i class="fas fa-file-signature text-success me-2"></i> <strong>Agregar acta</strong>: Permite añadir un acta al proyecto</li>
                            <li><i class="fas fa-file-export text-warning me-2"></i> <strong>Exportar</strong>: Permite exportar los datos del proyecto</li>
                        </ul>
                    </div>
